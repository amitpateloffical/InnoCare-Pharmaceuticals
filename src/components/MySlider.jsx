...
const MySlider = () => {
  ...
  return (
    <Slider {...settings} >
      ...
      <img height={"500px"} src="https://img.freepik.com/premium-photo/blurred-drugstore-background-defocus_841543-8501.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
      <img  height={"500px"} src="https://img.freepik.com/free-vector/medical-equipment-realistic-set-digital-thermometers-syringes-stethoscope-pressure-measuring-device-isolated-vector-illustration_1284-72849.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph"/>
